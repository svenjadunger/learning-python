...
def node_count(tree):
    if isinstance(tree[1], str):  # ist zweites element ein string? wenn ja: Blattknoten, zb the oder cat
        return 0 #0 zurückgeb, da blattknoten keine nicht-blattknoten sind
